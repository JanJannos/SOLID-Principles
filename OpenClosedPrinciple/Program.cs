...
namespace DotNetDesignPatternDemos.SOLID.OCP
{
    ...
    public class ProductFilter
    {
        ...
        // Which means that if we add only one filter at the beginning 
        // for example "FilterByColor" ... and then we came back to the class and 
        // added duplicates of that function , we broke the OCP !!!
    }
